...
from .dtmil_utils.backbone import build_WSIFeatureMapBackbone

from .dtmil_utils.deformable_transformer import build_deforamble_transformer
import copy
...
def DTMIL(ndim, n_classes):
    ...
    backbone = build_WSIFeatureMapBackbone(ndim)

    transformer = build_deforamble_transformer(ndim)
